...
import 'package:face_detection_camera/handlers/enum_handler.dart';
import 'package:face_detection_camera/handlers/face_identifier.dart';
import 'package:face_detection_camera/paints/face_painter.dart';
import 'package:face_detection_camera/paints/hole_painter.dart';
import 'package:face_detection_camera/res/builders.dart';
import 'package:face_detection_camera/utils/logger.dart';
...
class FaceCameraView extends StatefulWidget {
  ...
  final void Function(String? image) onCapture;
...
class _FaceCameraViewState extends State<FaceCameraView>
  ...
  void _getAllAvailableCameraLens() {
    for (CameraDescription d in FaceDetectionCamera.cameras) {
  ...
  Future<void> _initCamera() async {
    final cameras = FaceDetectionCamera.cameras
        .where((c) =>
            c.lensDirection ==
